# abi-decoder
Typoescript library for decoding data params and events from etherem transactions

Forked [https://github.com/ConsenSys/abi-decoder](https://github.com/ConsenSys/abi-decoder)

# Install
```
yarn add abi-decoder-typescript
```
